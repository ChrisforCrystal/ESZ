...
<ul class="nav nav-list">
    ...
    <li class="" id="buyPart">
        <a href="#" class="dropdown-toggle">
            ...
            <span class="menu-text"> 购物列表 </span>
    ...
    <li class="" id="shopCarList">
        <a href="#" class="dropdown-toggle">
            <i class="menu-icon fa fa-list"></i>
            <span class="menu-text"> 购物车列表 </span>
